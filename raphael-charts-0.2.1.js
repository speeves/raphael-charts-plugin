...
(function() {
	...
	var background = paper.rect(0, 0, canvasWidth, canvasHeight);
        ...
        if (o.backgroundFill == 'transparent') {
            backgroundParams = { "stroke" : "none", "fill-opacity" : 0};
        } else if (o.backgroundFill[0] == o.backgroundFill[1]) {
            backgroundParams = {stroke : "none", fill : o.backgroundFill[0]};
        } else {
            backgroundParams = {stroke : "none", fill : "90-" + o.backgroundFill[0] + "-" + o.backgroundFill[1]};
        }
